...
require (
	buf.build/gen/go/webitel/webitel-go/protocolbuffers/go v1.36.1-20250609124843-105d56479f4e.1 // indirect
	...
	github.com/webitel/webitel-go-kit/logging/wlog v0.0.0-20250529121314-348634f6ea7f // indirect
